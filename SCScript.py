...
Roberts_court = SupremeCourt('John Roberts', 'Antonin Scalia', 'Anthony Kennedy', 'Clarence Thomas', 'Ruth Bader Ginsburg', 'Stephen Breyer', 'Samuel Alito', 'Sonia Sotomayor', 'Elena Kagan')
